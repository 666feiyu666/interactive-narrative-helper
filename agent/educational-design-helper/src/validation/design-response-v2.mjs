...
export function validateCompactDesignResponse({
  response,
  request,
  retrieved,
  sentKnowledgeIds,
  ...
  if (response?.output_version !== "0.2") {
    errors.push("/output_version must be 0.2");
  }
...
export const designResponseV2Validation = Object.freeze({
