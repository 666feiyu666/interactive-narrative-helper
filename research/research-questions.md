...
short-term evidence target and two-track Helper relationship were refined on
2026-08-28. The Track B program scope was broadened on 2026-08-28 while the
counterfactual question was retained as Track B1. Downstream bridge and Track B
implementation contracts are not fixed.
...
Track B covers story-level technique exploration rather than autonomous story
writing. Technique-specific transformations may concern events and
consequences, perspective and information, time and sequence, or role and
agency. These examples define a conceptual space; they are not implemented
modules, confirmed experiments, or evidence of technique-general Agent
capability.

## Track B1 counterfactual research question
...
The counterfactual question remains the only currently specified Track B
technique research direction. Its stable cases and proposal contracts do not
serve as generic contracts for other narrative techniques.

## Track B1 operational subquestions

### RQ B1.1 — Alternative action generation

Can the Agent propose substantively different strategies available to a
character when a canonical action is removed or changed, rather than producing
surface paraphrases of the original strategy?

### RQ B1.2 — Consequence projection

Can the Agent project coherent causal paths from each alternative action through
other characters' reactions, new conflicts, further choices, and possible
endings?

### RQ B1.3 — Meaning projection

Can the Agent articulate plausible thematic and educational shifts that are
traceable to the changed action and its consequences, while representing them
as interpretations rather than authoritative answers?

### RQ B1.4 — Author utility and control

Can authors understand, select, revise, combine, or reject the Agent's proposals
in ways that expand their design space without reducing their creative and
interpretive control?

## Program and current-study non-goals

- Proving that an Agent can autonomously write a complete interactive story.
- Claiming that a Track B Agent can apply multiple narrative techniques merely
  because the program-level framework names a broader technique space.
...
- Claiming child-reader benefit from model outputs without an appropriate human
  study and ethics process.
